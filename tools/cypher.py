...
"""
    The chain will use the schema the Neo4jGraph class provides to write a Cypher statement 
    and execute it against the graph database.
...
"""
        -The- Problem
            If you look at the database, movies with a title starting with The have the The portion moved to the end in the .title property. 
